...
class ProfileDetailsService
{
    ...
    public function getUserProfileData(JWTUser $user): array
    {
        ...
        return [
            ...
            'avatar' => $this->fileFetcherHelper->loadUserPhotos($userData->getAvatar(), $userData, reset($userPhotos)->getStorage()),
            'photos' => $this->fileFetcherHelper->loadUserPhotos($userPhotos, $userData, reset($userPhotos)->getStorage()),
